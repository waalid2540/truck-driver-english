...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    categories.forEach((category, index) => {
      const id = index + 1;
      this.dotCategories.set(id, { ...category, id, questionsCount: category.questionsCount });
    });
    this.currentCategoryId = 7;

    // Officer & Driver Interaction Questions
    const questions: InsertDotQuestion[] = [
      // First 100 officer-driver interactions
      {
        categoryId: 6,
        question: "Officer: 'What are you hauling?' - Choose the best professional response:",
        options: [
          "I'm hauling refrigerated meat products for a grocery chain.",
          "Just some stuff for delivery.",
          "Mind your own business.",
          "I don't know, ask my dispatcher."
        ],
        correctAnswer: "I'm hauling refrigerated meat products for a grocery chain.",
        explanation: "Always be specific, professional, and cooperative when describing your cargo."
      },
      {
        categoryId: 6,
        question: "Officer: 'How far are you from your delivery location?' - Choose the best response:",
        options: [
          "I'm about 120 miles away from my drop-off point.",
          "Not far.",
      ...
      {
        categoryId: 6,
        question: "Officer: 'Are your load straps secure?' - Choose the best response:",
        options: [
          "Yes, I double-checked all straps before leaving the warehouse.",
          "I think so.",
          "They should be fine.",
          "I don't use straps."
        ],
      ...
      {
        categoryId: 6,
        question: "Officer: 'When did you last take a break?' - Choose the best response:",
        options: [
          "About 30 minutes ago, I stopped at a rest area for lunch.",
          "A while ago.",
          "I don't take breaks.",
          "Can't remember."
        ],
      ...
      {
        categoryId: 6,
        question: "Officer: 'Are you hauling perishable goods?' - Choose the best response:",
        options: [
          "Yes, I'm transporting frozen vegetables in a reefer trailer.",
          "Maybe.",
          "What's it to you?",
      ...
      {
        categoryId: 6,
        question: "Officer: 'What company are you driving for?' - Choose the best response:",
        options: [
          "I'm with American Freight Logistics, based in Chicago.",
